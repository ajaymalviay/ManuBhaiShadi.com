...
//                 ),
//                 SizedBox(height: 10,),
//                 addonList.length == 0 ? SizedBox() :     ListView.builder(
//                   // padding: EdgeInsets.symmetric(horizontal: 30),
//                     shrinkWrap: true,
//                     itemCount: addonList.length,
//                     itemBuilder: (c,i){
//                       print("addon list here ${addonList}");
//                       List<dynamic> decodedData = json.decode(json.encode(addonList)) as List;
//                       print("ddddssssss ${decodedData}");
//                       var fianlData = decodedData[i];
//                       print("new final data ${fianlData}");
//                       print("csfsfsfsfsfsfs ${fianlData['service']}");
//                       return Container(
...
//                           crossAxisAlignment: CrossAxisAlignment.start,
//                           children: [
//                             Expanded(child: Text("${fianlData["service"]}")),
